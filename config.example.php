...
define('MAIL_ENABLED', mbtb_env_bool('MAIL_ENABLED', false));
define('MAIL_HOST', (string) mbtb_env('MAIL_HOST', 'smtp.gmail.com'));
define('MAIL_PORT', (int) mbtb_env('MAIL_PORT', '587'));
define('MAIL_USERNAME', (string) mbtb_env('MAIL_USERNAME', 'your-email@example.com'));
define('MAIL_PASSWORD', (string) mbtb_env('MAIL_PASSWORD', ''));
define('MAIL_ENCRYPTION', (string) mbtb_env('MAIL_ENCRYPTION', 'tls'));
define('MAIL_FROM_ADDRESS', (string) mbtb_env('MAIL_FROM_ADDRESS', 'your-email@example.com'));
